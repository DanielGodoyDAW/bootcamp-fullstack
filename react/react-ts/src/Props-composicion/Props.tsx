import CourseCard from "./Ejercicio02/CourseCard";
import Separador from "../Separador";
import ProfileCard from "./Ejercicio03/ProfileCard";
import TechCard from "./Ejercicio04/TechCard";
import ModuleCard from "./Ejercicio05/ModuleCard";
import { StudentCardA, StudentCardB } from "./Ejercicio06/StudentCard";
import Panel from "./Ejercicio07/Panel";
import InfoCard from "./Ejercicio08/InfoCard";
import InfoCardContainer from "./Ejercicio08/InfoCardContainer";
import TargetCurso from "./Ejercicio09/TargetCurso";
import SectionBlock from "./Ejercicio11/SectionBlock";
import Header from "./Ejercicio12/Header";
import Target from "./Ejercicio12/Target";
